...
function AboutPage() {
  return (
      <section className="container mx-auto">
        ...
        <p className="text-3xl text-slate-300">Esta es una aplicacion sencilla CRUD, Create, Read, Update, Delete de tareas utilizando SQLite, Nextjs, Prisma y Tailwindcss</p>
